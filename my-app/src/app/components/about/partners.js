  ...
  return (
    <div className="mx-auto mt-10 space-y-8">
      <div className=" text-center md:text-end w-full md:w-11/12">
        <h3 className="text-3xl font-semibold">Our Partners</h3>
      </div>
      ...
      <div className="grid grid-cols-2 place-items-center gap-54 md:grid-cols-4 md:gap-5  lg:flex lg:justify-center lg:space-x-6 mx-auto">
